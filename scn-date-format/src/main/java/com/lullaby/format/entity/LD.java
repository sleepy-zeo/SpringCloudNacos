...
public class LD extends JSR310DateTimeDeserializerBase<LocalDateTime> {
    private static final long serialVersionUID = 1L;
    private static final DateTimeFormatter DEFAULT_FORMATTER;
    public static final LD INSTANCE;

    private LD() {
        this(DEFAULT_FORMATTER);
    }

    public LD(DateTimeFormatter formatter) {
        super(LocalDateTime.class, formatter);
    }

    protected LD(LD base, Boolean leniency) {
        super(base, leniency);
    }

    protected LD withDateFormat(DateTimeFormatter formatter) {
        return new LD(formatter);
    }

    protected LD withLeniency(Boolean leniency) {
        return new LD(this, leniency);
    }

    protected LD withShape(JsonFormat.Shape shape) {
        return this;
    }
